...
- Use FastAPI with SQLAlchemy, Alembic, and Pydantic as the starting backend stack
...
- Include unified action/audit logging for authentication, recipe changes, comments, favorites, moderation actions, bans, and role promotions

## Deliverables

- Endpoint contracts and payload shapes
- Validation and authorization rules
- Unified action/audit logging behavior and payload details
